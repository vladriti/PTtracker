...
.app { width: 100%; padding: 0 0 80px; min-height: 100vh; }
.nav { display: flex; justify-content: space-between; align-items: center; padding: 20px 20px 16px; position: sticky; top: 0; background: var(--bg); z-index: 10; border-bottom: 1px solid var(--border); width: 100%; }
...
.tabs { display: flex; gap: 4px; padding: 12px 20px; background: var(--bg); width: 100%; }
...
.hero { width: 100%; padding: 20px 20px 12px; }
...
.next-banner { width: calc(100% - 40px); margin: 0 20px 10px; background: var(--surface2); border: 1px solid var(--border2); border-radius: var(--radius); padding: 14px 16px; display: flex; justify-content: space-between; align-items: center; }
